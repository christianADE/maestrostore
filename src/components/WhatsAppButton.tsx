        ...
        <div className="fixed bottom-8 right-8 z-50 animate-fade-in">
            <div className="relative group">
                ...
                <button
                    ...
                    className="w-16 h-16 rounded-full bg-[#25D366] hover:bg-[#128C7E] text-white shadow-luxury hover:scale-110 transition-all duration-300 flex items-center justify-center border-none cursor-pointer overflow-hidden relative"
